...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-1.1.1-brightgreen?style=for-the-badge" alt="Version" />
</p>
...
```powershell
powershell -ExecutionPolicy Bypass -File tools\build-release.ps1 -Version 1.1.1
```
打包成功后，将在 `publish\AirPlayer-1.1.1-win-x64\` 中生成免安装绿色版本（包含 exe 启动程序、所有依赖运行时以及自动嵌入的 `fdk-aac.dll`）。
